...
<body>
  ...
  <div class="container-fluid">
    <div class="col-md-12"  style="display: flex; justify-content: end;  margin: 0px; padding:0px; margin-bottom: 4px;">
        <input type="hidden" value="<?php echo $ids = $_GET['ids']; ?>" id="printButton">
        <button type="button" class="btn btn-primary" id="printPage"><i class="fa-solid fa-print"></i> Print</button>
      </div>
...
// print code written over here 
// print code written over here 
var printPage = $("#printButton").val();
var printButton = $("#printPage");
    $(printButton).click(function() {
        // Fetch the content of 'print.php' using AJAX
        $.ajax({
            url: 'print.php?ids=' + printPage,
            type: 'GET',
            success: function(response) {
                // Create a new window with the fetched content
                var printWindow = window.open('', '', 'width=1600, height=600');
            ...
            error: function() {
                alert('Failed to fetch content for printing.');
            }
        });
    });
