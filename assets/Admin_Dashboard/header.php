...
<head>
    ...
    <link rel="stylesheet" href="assets\css\table_style.css">
...
var chartTwoBar = new CanvasJS.Chart("chartContainerNo3", {
    	...
    	theme: "light2",
    	title:{
    		text: "Experience And Interest on Various Department"
    	},
    	axisY:{
    		includeZero: true
    	},
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background:black;">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link" href="userLogged.php">
                    <i class="fa fa-user" aria-hidden="true"></i>
            ...
            <li class="nav-item">
                <a href="#submenu2" data-bs-toggle="collapse" class="nav-link align-middle text-white">
                  <i class="fa fa-file" aria-hidden="true"></i>
                  <span href="#submenu2" class="ms-1 d-none d-sm-inline text-white">Evaluation Report</span>
                </a>
                <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                  <li class="w-100 text-white">
                    <a href="#" class="nav-link text-white">
                        <i class="fas fa-sms"></i>
                      <span class="d-none d-sm-inline text-white">Sent Event Details</span>
                    </a>
                  </li>
                   <li class="w-100 text-white">
                    <a href="#" class="nav-link text-white">
                        <i class="fas fa-sms"></i>
                      <span class="d-none d-sm-inline text-white">Sent Notificatin Details</span>
                    </a>
                  </li>
                </ul>
              </li>
