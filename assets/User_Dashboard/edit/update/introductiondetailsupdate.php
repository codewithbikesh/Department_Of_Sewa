...
<!-- end passport size photo code line from here  -->
 <div class="row">
  ...
  <span class="fs-4"><input class="form-check-input" type="checkbox" value=""  name="Role" <?php echo ($row['rRole'] == 'Volunteer') ? 'checked' : ''; ?> id="flexCheckDefault"></span>
    ...
    <div class="col-md-2 d-flex justify-content-end align-items-center">
        <div id="imgArea"><img id="blah" src="../../../image_upload/profilPicture/<?php echo $row['image']; ?>" alt="your image" width="80" height="80"/>
          ...
          <div id="imgChange"><span>Photo</span>
                <input type="file" accept="image/png, image/jpeg" name="image_upload_file" id="image_upload_file" onchange="uploadFile()" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
 ...
 <div class="row">
    ...
    <div class="row">
      <div class="col-md-4 col-sm-12 mt-2">
       <div class="row">
        <div class="col-md-6">
        <label for="inputCity" class="form-label" style="display:flex; text-align:center; align-items:center;">जन्म मिति: बि.सं.<span class="member_formValidation" style="color:red; display:flex; font-size:20px;">*</span></label>
        </div>
        <div class="col-md-6">
...
//   if checked then take value volunteer 
  if ($("#flexCheckDefault").is(":checked")) {
    ...
    if (!$("#flexCheckDefault").is(":checked")) {
      let currentValue = $("#flexCheckDefault").val();
      let newValue = currentValue + "Member";
      $("#flexCheckDefault").val(newValue);
    }
