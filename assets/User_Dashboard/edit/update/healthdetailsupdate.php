    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12 mt-2">
        <span class="SpanStyle">
          <label for="inputState" class="form-label" style="width: 30%; display:flex; text-align:center; align-items:center;">रक्त समुह:<span class="member_form_validation" style="color:red; display:flex; font-size:20px;">*</span></label>
