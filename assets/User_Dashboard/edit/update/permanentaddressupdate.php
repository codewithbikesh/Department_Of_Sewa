<!-- start new update query for permanentaddress code line from here  -->
  ...
  $conn = connectMyDB();
   ...
   $result = mysqli_query($conn, $sql);
    ...
    <!-- bikes -->
            ...
            if (mysqli_num_rows($req) > 0) {
              while ($data = mysqli_fetch_assoc($req)) {
                ...
                // echo $row;
                 ...
                 echo  $data['province'] ." ". $row['rProvince'];
          
                if($data['province'] == $row['rProvince']){
                    
                    ?>
       
                 <option value="<?php echo $data['province']; ?>" selected><?php echo $data['province']; ?></option>
              <?php  } else{?>
      ...
      <div class="col-md-3 col-sm-12 mt-2">
         <div class="row">
          ...
          <label for="district" class="form-label" style="display:flex; text-align:center; align-items:center;">जिल्ला : <span class="member_form_validation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-8">
      ...
      <div class="row">
          ...
          <label for="municipality" class="form-label" style="display:flex; text-align:center; align-items:center;">न.पा/गा.पा.:<span class="member_form_validation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-9">
      ...
      <div class="row">
          <div class="col-md-4" style="padding: 0px 5px;">
          <label for="wardNo" class="form-label" style="display:flex; text-align:center; align-items:center;">वाड नं.:<span class="member_form_validation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-8">
          <input type="text" class="form-control WardNo1 WardNo2 InputStyle" id="pWardNo" name="pWardNo" value="<?php echo $row['rWard'] ?>">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="row">
          <div class="col-md-5">
          <label for="telephone" class="form-label" style="display:flex; text-align:center; align-items:center;">टेलिफोन नं.:</label>
          </div>
          <div class="col-md-7">
          <input type="text" name="pTelephoneNo" class="form-control pPhoneNo2 pPhoneNo3 InputStyle" id="TelephoneNo" value="<?php echo $row['rTelephoneNo'] ?>">
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-12 mt-2">
      <div class="row">
          <div class="col-md-4" style="padding: 0px 5px;">
          <label for="mobile" class="form-label" style="display:flex; text-align:center; align-items:center;">माेबाईल नं.:<span class="member_form_validation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-8">
          <input type="text" name="pMobileNo" class="form-control pMobileNo pMobileNo1 InputStyle" id="MobileNo" value="<?php echo $row['rMobileNo'] ?>">
          </div>
        </div>
      </div>
      ...
      <div class="row">
          <div class="col-md-2">
          <label for="email" class="form-label" style="display:flex; text-align:center; align-items:center;">इमेल:<span class="member_form_validation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-10">
          <input type="email" name="pEmail" class="form-control InputStyle" id="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,3}$" value ="<?php echo $row['rEmail'] ?>">
          </div> 
        </div>
      </div>
    </div>
...
if (Email.trim() === '') {
    ...
    //   Auto fetch the value while checked the sameaspermanentaddress box code line from here 
    //   Auto fetch the value while checked the sameaspermanentaddress box code line from here 
...
<!-- end new update query for permanentaddress code line from here  -->
