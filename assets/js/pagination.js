...
$(function() {
    var numberOfItems = $(".container-fluid .row .pagination-show").length;
    ...
    function showPage(whichPage) {
        ...
        $(".container-fluid .row .pagination-show").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
