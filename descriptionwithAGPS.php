  ...
  <div class="row" id="rowStyle">
    ...
    <div class="col-md-3 col-sm-12 mt-2">
        <div class="row">
          ...
          <label for="district" class="form-label" style="display:flex; text-align:center; align-items:center;">क्षेत्र :<span class="member_formValidation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
      ...
      <div class="col-md-3 col-sm-12 mt-2">
        <div class="row">
          <div class="col-md-4">
          <label for="inputState" class="form-label" style="display:flex; text-align:center; align-items:center;">जिल्ला:<span class="member_formValidation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-8">
      ...
      <div class="col-md-3 col-sm-12 mt-2">
        <div class="row">
          <div class="col-md-4">
          <label for="d_center" class="form-label" style="display:flex; text-align:center; align-items:center;">केन्द्र:<span class="member_formValidation" style="color:red; display:flex; font-size:20px;">*</span></label>
          </div>
          <div class="col-md-8">
          <!--<input type="text" name="d_Center" class="form-control centerAddress1 centerAddress2 InputStyle"  id="d_center">        -->
          <select name="agpscenter" onchange="other(this)" id="d_center" class="InputStyle form-select" aria-label="Default select example" style="font-weight: bold; font-size: 12px;">
            <option value="">Select&nbsp;&nbsp;</option>
            <!--<option value="Other" class="otherField" id="OtherCn" onchange="other(this)">Other Center </option>-->
          </select>
           <input type="text" name="agpscenter" class="form-control InputStyle" id="otherCenter" style="width:145px;" placeholder="Other Center">
          </div>
        </div>
      ...
      <div class="col-md-3 col-sm-12 mt-2">
       <div class="row">
        <div class="col-md-4" style="padding: 0px 5px;">
        <label for="inputZip" class="form-label" style="display:flex; text-align:center; align-items:center;">ज्ञान प्राप्त साल:<span class="member_formValidation" style="color:red; display:flex; font-size:20px;">*</span></label>
        </div>
        <div class="col-md-8">
        <input type="text" name="d_QualificationYears" class="form-control Years Years1 special2 InputStyle" id="d_QualificationYears">
        </div>
      </div>
      </div>
      ...
      <div class="col-md-4 col-sm-12 mt-2">
        <div class="row">
          ...
          <input type="text" name="d_SmartCardNo" class="form-control SmartCardNo SmartCardNo1 InputStyle" id="smartCardNo">
          </div>
        </div>
    </div>
